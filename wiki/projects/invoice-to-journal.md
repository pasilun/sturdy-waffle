...
- **Hard fixture** `devops.pdf` — six-line IT consultancy invoice spreading across the four similar 65xx codes plus 5400. Haiku scores 5/6 with 0.88 avg confidence; the eval harness ([[llm-eval-as-dev-canary]]) can now empirically discriminate Sonnet from Haiku.
